#pragma checksum "C:\Users\millz\Desktop\container\Pack\project 04\Project\Views\faqs.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b6941123007d6e7c860dca2612d73b458a0f95b1"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(digitalhealthza.Pages.Views_faqs), @"mvc.1.0.view", @"/Views/faqs.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b6941123007d6e7c860dca2612d73b458a0f95b1", @"/Views/faqs.cshtml")]
    ...
    #nullable restore
    public class Views_faqs : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    #nullable disable
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "C:\Users\millz\Desktop\container\Pack\project 04\Project\Views\faqs.cshtml"
...
#nullable disable
 ...
 <!-- Hero -->
      <section class=""position-relative overflow-hidden"">
        <div class=""position-relative bg-dark zindex-4 pt-lg-3 pt-xl-5"">
          ...
          <div class=""container zindex-5 pt-5"">
            <div class=""row justify-content-center text-center pt-4 pb-sm-2 py-lg-5"">
              <div class=""col-xl-8 col-lg-9 col-md-10 py-5"">
                <h1 class=""display-4 text-light pt-sm-2 pb-1 pb-sm-3 mb-3"">What Do You Want To Know</h1>
          ...
          <div class=""d-flex position-absolute top-100 start-0 w-100 overflow-hidden mt-n4 mt-sm-n1"" style=""color: var(--si-gray-900);"">
            <div class=""position-relative start-50 translate-middle-x flex-shrink-0"" style=""width: 3788px;"">
              <svg xmlns=""http://www.w3.org/2000/svg"" width=""3788"" height=""144"" viewBox=""0 0 3788 144""><path fill=""currentColor"" d=""M0,0h3788.7c-525,90.2-1181.7,143.9-1894.3,143.9");
            WriteLiteral(@"S525,90.2,0,0z""/></svg>
            </div>
          </div>
        ...
        <div class=""position");
            WriteLiteral(@"-absolute top-0 start-0 w-100 h-100"" style=""background-color: rgba(255,255,255,.05);""></div>
      </section>
        ...
        <div class=""container position-relative zindex-5 pb-md-4 pt-md-2 pt-lg-3 pb-lg-5"">
          ...
          <div class=""row row-cols-1 row-cols-sm-2 row-cols-md-3 g-0 pb-xl-3"">
            ...
            <div class=""col position-relative"">
              ...
              ");
            WriteLiteral(@"    <img src=""assets/img/landing/saas-2/features/comments.svg"" width=""40"" alt=""Comments"">
                </div>
            ...
            <div class=""col position-relative"">
              <div class=""card border-0 bg-transparent rounded-0 p-md-1 p-xl-3"">
                ...
                <div class=""card-body text-center"">
         ");
            WriteLiteral(@"         <h3 class=""h5 pb-1 mb-2"">Tasks Analytics</h3>
            ...
            <div class=""col position-relative"">
              <div class=""card border-0 bg-transparent rounded-0 p-md-1 p-xl-3"">
                <div class=""d-table bg-secondary rounded-3 p-3 mx-auto mt-3 mt-md-4"">
                  <img src=""assets/img/landing/saas-2/features/group.svg"" width=""40"" alt=""Group"">
                </div>
                <div class=""card-body text-center"">
    ...
    ");
            ...
            <div class=""col position-relative"">
              ...
              <hr class=""position-absolute top-0 end-0 w-1 h-100 d-none d-md-block"">
              <hr class");
            WriteLiteral(@"=""position-absolute top-100 start-0 w-100 d-none d-sm-block d-md-none"">
            </div>
    ...
    ");
            WriteLiteral(@"          <div class=""mx-n5 mx-xl-0"">
      ...
      <section class=""container py-5 my-2 my-md-4 my-lg-5"">
        <div class=""row pt-2 py-xl-3"">
          ...
          <div class=""col-lg-9 col-md-8"">
            ...
            WriteLiteral(@""" data-swiper-options='{
              ""slidesPerView"": 1,
              ""spaceBetween"": 8,
              ""loop"": true,
              ""navigation"": {
                ...
                <div class=""swiper-slide h-auto pt-4"">
                  <figure class=""d-flex flex-column h-100 px-2 px-sm-0 mb-0 mx-2"">
                    <div class=""card h-100 position-relative border-0 shadow-sm pt-4"">
                      <span class=""btn btn-icon btn-primary shadow-primary pe-none position-absolute top-0 start-0 translate-middl");
            WriteLiteral(@"e-y ms-4"">
                    ...
                    <figcaption class=""d-flex align-items-center ps-4 pt-4"">
                      <img src=""assets/img/avatar/16.jpg"" width=""48"" class=""rounded");
            WriteLiteral(@"-circle"" alt=""Robert Fox"">
                      <div class=""ps-3"">
                ...
                <div class=""swiper-slide h-auto pt-4"">
                  <figure class=""d-flex flex-column h-100 px-2 px-sm-0 mb-0 mx-2"">
                    <div class=""card h-100 position-relative border-0 shadow-sm pt-4"">
                      ...
                      <blockquote class=""card-body pb-3 mb-0"">
                        <p class=""mb-0"">Phasellus luctus nisi id orci condimentum, at cursus nisl vestibulum. Orc");
            WriteLiteral(@"i varius natoque penatibus et magnis dis parturient montes commodo.</p>
                      </blockquote>
                      <div class=""card-footer border-0 text-nowrap pt-0"">
                        <i class=""bx bxs-star text-warning""></i>
                        <i class=""bx bxs-star text-warning""></i>
            ...
            WriteLiteral(@" shadow-sm pt-4"">
                    ...
                    <figcapti");
            WriteLiteral(@"on class=""d-flex align-items-center ps-4 pt-4"">
          ...
          <div class=""row align-items-center py-sm-2"">
            ...
            <div class=""col-md-7 col-lg-6 offset-xl-1"">
              <div class=""position-relative mx-auto mb-5 m-md-0"" style=""max-width: 526px;"">
                <img src=""assets/img");
            WriteLiteral(@"/landing/saas-2/device.png"" class=""d-block"" alt=""Device"">
...
");
            WriteLiteral(@"                      <div class=""text-nowrap fs-sm pb-lg-1 mb-2"">
                        <i class=""bx bxs-star text-warning""></i>
                        <i class=""bx bxs-star text-warning""></i>
                        <i class=""bx bxs-star text-warning""></i>
                        <i class=""bx bxs-star text-warning""></i>
            ...
            WriteLiteral(@"            </div>
                ...
                <div class=""col-sm-6 col-md-12"">
                  <div class=""row row-cols-1 row-cols-lg-2 align-items-end text-center text-md-start"">
                    ...
                    <div class=""col d-lg-flex justify-content-end"">
                      <a h");
            WriteLiteral(@"ref=""#"" class=""btn btn-dark btn-lg px-3 py-2"">
      ...
      <section class=""container pt-5"">
        ...
        <div class=""table-responsive-lg"">
          <div class=""d-flex align-items-center pb-4"">
            ...
            WriteLiteral(@""" style=""width: 64%; min-width: 32rem;"">
      ...
      <section class=""container mt-n1 mt-md-0 py-5"">
        <div class=""row justify-content-center text-center pt-md-3 pb-4 py-lg-5 mb-1"">
          <div class=""col-xl-8 col-lg-9 col-md-10"">
            ...
            WriteLiteral(@"volutpat mollis egestas. Nam luctus facilisis ultrices. Pellentesque volutpat ligula est. Mattis fermentum, at nec lacus.</p>
          </div>
        </div>
        <div class=""row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-2 g-sm-3 g-lg-4 pb-md-3 pb-lg-5"">
          ...
          <div class=""col"">
            <div class=""card card-body card-hover bg-light border-0"">
              <img src=""assets/img/brands/google.svg"" class=""d-block mb-4"" width=""56"" alt=""Google"">
          ...
          <div class=""col"">
            <div class=""card card-body card-hover bg-light border-0"">
              <img src=""assets/img/brands/zoom.svg"" class=""d-block mb-4"" width=""56"" alt=""Zoom"">
    ...
    ");
          ...
          <div class=""col"">
            <div class=""card card-body card-hover bg-light border-0"">
              <img src=""assets/img/brands/slack.svg"" class=""d-block mb-4"" width=""56"" alt=""Slack"">
              <p class=""mb-0"">Id mollis consectetur congue egestas egestas suspendisse blandit justo.</p>
            </div>
          </div>
          ...
          <div class=""col"">
            <div class=""card card-body card-hover bg-light border-0"">
              <img src=""assets/img/brands/gmail.svg"" class=""d-block mb-4"" width=""56"" alt=""Gmail"">
          ...
          <div class=""col"">
            <div class=""card card-body card-hover bg-light border-0"">
              <img src=""assets/img/brands/trello.svg"" class=""d-block mb-4"" width=");
            WriteLiteral(@"""56"" alt=""Trello"">
          ...
          <div class=""col"">
            <div class=""card card-body card-hover bg-light border-0"">
              <img src=""assets/img/brands/mailchimp.svg"" class=""d-block mb-4"" width=""56"" alt=""Mailchimp"">
          ...
          <div class=""col"">
            <div class=""card card-body card-hover bg-light border-0"">
              <img src=""assets/img/brands/dropbox.svg"" class=""d-block mb-4"" width=""56"" alt=""Dropbox"">
          ...
          <div clas");
            WriteLiteral(@"s=""col"">
            <div class=""card card-body card-hover bg-light border-0"">
              <img src=""assets/img/brands/evernote.svg"" class=""d-block mb-4"" width=""56"" alt=""Evernote"">
